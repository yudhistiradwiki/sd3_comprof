...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <h1 class="display-3 text-white animated slideInRight">Papan Informasi</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb animated slideInRight mb-0">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Papan Informasi</li>
            </ol>
        </nav>
    </div>
</div>
                ...
                <div class="blog__area-item wow fadeInUp" data-wow-delay="0.8s">
                    ...
                    <div class="blog__area-item-content pt-0">
                        ...
                        <p style="font-size: 13">
                            Ditulis oleh : {{$data->writer}}
                        </p>
                        <p style="font-size: 17">
                            {{ \Illuminate\Support\Str::limit($data->description, 89) }}
                        </p>
                        <ul>
                        </ul>
