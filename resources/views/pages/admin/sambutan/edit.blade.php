...
<div class="row">
    <div class="col-md-12">
        <div class="mb-4 card">
            <h5 class="card-header">Update Sambutan</h5>

            <hr class="my-0" />
            <div class="card-body">
                <form action="{{ route('admin.sambutan.update', $sambutan->id) }}" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control @error('nama_kepsek') is-invalid @enderror" type="text" id="firstName"
                                name="nama_kepsek" value="{{ $sambutan->nama_kepsek }}" autofocus />
                            @error('nama_kepsek')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" name="pathFile" value="{{ $sambutan->file }}" hidden>
