...
<div class="row">
    <div class="col-md-12">
        <div class="mb-4 card">
            ...
            <hr class="my-0" />
            <div class="card-body">
                <form action="{{ route('admin.ppdb.update', $ppdb->id) }}" id="formAccountSettings"
                    ...
                    <div class="mb-4 row">
                        <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control  @error('title') is-invalid @enderror" type="text"
                                id="firstName" name="title" value="{{ old('title', $ppdb->title) }}"
                                autofocus />
                            @error('title')
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control  @error('subtitle') is-invalid @enderror" id="subtitle"
                                name="subtitle">{{ old('subtitle', $ppdb->subtitle) }}</textarea>
                            @error('subtitle')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
