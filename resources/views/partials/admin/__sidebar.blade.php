<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="/admin/dashboard" class="app-brand-link">
            @if (isset($profile) && $profile->logo !== null)
                <img src="{{ $profile->logo ? asset($profile->logo) : asset('logo/logo.png') }}" alt="logo"
                    class="app-brand-logo demo" width="40">
            @endif
    ...
    <ul class="py-1 menu-inner">
        ...
        {{-- Sambutan --}}
        <li class="menu-item {{ request()->is('admin/sambutan') ? 'open active' : '' }}">
            <a href="/admin/sambutan" class="menu-link">
                <i class="menu-icon tf-icons bx bx-chat"></i>
                <div data-i18n="Basic">Sambutan</div>
            </a>
        </li>
