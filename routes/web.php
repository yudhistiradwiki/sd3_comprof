...
Route::prefix('admin')->group(function () {
    Route::middleware('auth', 'role:admin')->group(function () {
        ...
        //PPDB
        route::resource('/ppdb', PpdbController::class, ['as' => 'admin']);

        Route::get('/ppdb/{id}/whyitem/create', [PpdbController::class, 'createWhyItem'])->name('whyItem.create');
        Route::post('/ppdb/{id}/whyitem/store', [PpdbController::class, 'storeWhyItem'])->name('whyItem.store');

        Route::get('/ppdb/{ppdb}/whyitem/{ppdbdetail}/edit', [PpdbController::class, 'editWhyItem']);
        Route::put('/ppdb/{ppdb}/whyitem/{ppdbdetail}/update', [PpdbController::class, 'updateWhyItem']);
        Route::get('/ppdb/{ppdb}/whyitem/{ppdbdetail}', [PpdbController::class, 'destroyWhyItem']);
...
Route::get('/sambutan', [LandingPageController::class, 'sambutan'])->name('home.sambutan');

Route::get('/ppdb', [LandingPageController::class, 'ppdb'])->name('home.ppdb');

Route::get('/ummi', function () {
    return view('pages.landingpage.ummi');
});
